...
var quiz = {
    JS: [
        {
            id: 1,
            question: "Do you have set haircare routine?",
            name: "routine",
            options: [
                {
                    a: "Yes",
        ...
        {
            id: 2,
            question: "What are your major hair issues?",
            name: "issue",
                ...
                if (quiz.JS[this.currentque].options[0].hasOwnProperty(key)) {
                    $("#question-options").append(
                        "<div class='form-check option-block'>" +
                            ...
                            "<input type='radio' class='form-check-input' name='"+ quiz.JS[this.currentque].name +"'   id='q" +
                            key +
                            "' value='" +
